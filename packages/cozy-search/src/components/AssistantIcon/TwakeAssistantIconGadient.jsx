...
export const TwakeAssistantIconGadient = props => {
  return (
    <svg viewBox="0 0 22 22" fill="none" {...props}>
      <defs>
        <linearGradient
          ...
          y2="0%"
        >
          <stop offset="0%" stopColor="rgba(0, 183, 255, 0.9)" />
          <stop offset="77.81%" stopColor="rgba(224, 109, 209, 0.9)" />
          <stop offset="100%" stopColor="rgba(255, 255, 0, 0.9)" />
        </linearGradient>
      </defs>
      <path
        fillRule="evenodd"
